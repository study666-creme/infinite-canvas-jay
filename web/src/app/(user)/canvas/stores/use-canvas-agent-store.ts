...
export type AgentPendingToolCall = { requestId: string; name: string; input?: Record<string, unknown> & { ops?: CanvasAgentOp[] }; creativeActionId?: string; mandatoryCreativeConfirmation?: boolean };
export type AgentThreadSummary = { id: string; preview: string; name?: string | null; cwd?: string; status?: string; source?: unknown; createdAt?: number; updatedAt?: number };
export type AgentPanelTab = "chat" | "setup" | "history" | "log";
export type CanvasAgentCreativeMode = "general" | "short_drama";
...
type CanvasAgentStore = {
    ...
    creativeMode: CanvasAgentCreativeMode;
