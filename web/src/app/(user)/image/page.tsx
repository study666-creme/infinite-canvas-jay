    ...
    return (
        <>
            ...
            <div className="col-span-2">
                <ImageSettingsPanel config={config} onConfigChange={(key, value) => updateConfig(key, value)} theme={theme} variant="jimeng" showTitle={false} className="space-y-4" maxCount={10} />
            </div>
        </>
    );
}
